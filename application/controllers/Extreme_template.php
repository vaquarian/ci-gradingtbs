...
class Extreme_template extends CI_Controller {
  ...
  public function __construct()
  {
    ...
    $this->load->model( 'extreme_template_model', 'extreme_template' );
  ...
  private function is_allowed()
  {
    ...
    $this->access = $this->role_access->get_crud_access( 'Extreme Email Template', $this->session->userdata['role_id'] );
  ...
  {
    $V3xenore5brc = array(
      'title' => 'Extreme Condition Email Template',
      'description' => '',
      'js_files' => array(
        ...
        base_url() . 'assets/js/custom/vs.template.extreme.js'
      ),
    ...
    $this->load->view( 'extreme_template/index', $V3xenore5brc );
    $this->load->view( 'modal/extreme_template_modal_form', $V3xenore5brc );
    $this->load->view( 'modal/estate_modal', $V3xenore5brc );
    $this->load->view( 'modal/division_modal', $V3xenore5brc );
  ...
  public function template_list( $Vvlp2zayn0ey = 'vsp' )
  {
    if ( $Vvlp2zayn0ey == 'vsp' || $Vvlp2zayn0ey == 'vsc' )
    {
      ...
      $V3xenore5brc = array();
      $Vknd1marzr2z = $this->extreme_template->get_datatables( $Vxj1oacjn402, $V0fomgg0qq33, $V2tpzhezkaxa, $Vpcmffkcdohy );
      foreach ( $Vknd1marzr2z as $Vodzcrtex3uw ) 
      {
        ...
        $Vcyrw50em1ux[] = $Vodzcrtex3uw->division_name;
      ...
      $Vn3nfj5vah4x = array(
        "draw" => $V1vl4f3wf3ia,
        "recordsTotal" => $this->extreme_template->count_all(),
        "recordsFiltered" => $this->extreme_template->count_filtered( $V2tpzhezkaxa, $Vpcmffkcdohy ),
        "data" => $V3xenore5brc,
      );
  ...
  public function template_add()
  {
    ...
    $this->extreme_template->save( $V3xenore5brc );
  ...
  {
    $V3xenore5brc = $this->extreme_template->get_by_id( $V0onjqf41sze );
  ...
  public function template_update()
  {
    ...
    $this->extreme_template->update(array(
  ...
  {
    $this->extreme_template->delete_by_id( $V0onjqf41sze );
    echo json_encode( array("status" => TRUE) );
    exit();
  }
